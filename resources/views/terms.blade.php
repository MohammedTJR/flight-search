            ...
            <div class="container py-4">
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb small">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}" class="text-white-50">Inicio</a>
                                </li>
                                <li class="breadcrumb-item active text-white" aria-current="page">Términos y Condiciones
                                </li>
                            </ol>
                        </nav>
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0 text-center">
                        <img src="{{ asset('img/terms-document.png') }}" alt="Documento legal" class="img-fluid"
                    ...
                    <div class="terms-content my-5">
                        ...
                        <section class="mb-5">
                            <div class="alert alert-warning">
                                <i class="fas fa-exclamation-triangle me-2"></i> <strong>Importante:</strong> Al utilizar
                                FlyLow, aceptas estos Términos y Condiciones en su totalidad. Si no estás de acuerdo, no
                                utilices nuestro servicio.
                            </div>
                            <p>Los presentes Términos y Condiciones regulan el uso del sitio web <strong>FlyLow</strong> (en
                                adelante, "el Servicio"), operado por <strong>MOTJR</strong> (en adelante, "nosotros",
                                "nuestro" o "la Empresa").</p>
                        </section>
                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-body">
                                    <dl class="row">
                                        ...
                                        <dd class="col-md-9">Plataforma digital de comparación de vuelos accesible via web y
                                            aplicaciones móviles.</dd>

                                        <dt class="col-md-3">Usuario</dt>
                                        <dd class="col-md-9">Persona física o jurídica que accede o utiliza el Servicio.
                                        </dd>

                                        <dt class="col-md-3">Contenido</dt>
                                        <dd class="col-md-9">Datos, información, precios, textos, gráficos y demás elementos
                                            disponibles en el Servicio.</dd>

                                        <dt class="col-md-3">Socio Proveedor</dt>
                                        <dd class="col-md-9">Aerolíneas, agencias de viajes y otros proveedores de servicios
                                            de viaje cuyos productos se muestran en el Servicio.</dd>

                                        <dt class="col-md-3">Tarifa</dt>
                                        <dd class="col-md-9">Precio total mostrado para un vuelo, incluyendo tasas y cargos
                                            aplicables.</dd>
                                    </dl>
                                </div>
                            </div>
                        ...
                        <section id="uso-servicio" class="mb-5">
                            ...
                            <div class="card border-0 shadow-sm mb-4">
                                <div class="card-header bg-white border-0">
                                    <h3 class="h5 fw-bold mb-0"><i class="fas fa-check-circle text-success me-2"></i>
                                        Requisitos</h3>
                                </div>
                                <div class="card-body">
                                    <ul>
                                        <li>Debes tener al menos <strong>18 años</strong> o contar con consentimiento
                                            parental.</li>
                                        <li>Proporcionar información <strong>veraz y actualizada</strong>.</li>
                                        <li>No utilizar el Servicio para fines <strong>ilegales o no autorizados</strong>.
                                        </li>
                                        <li>Aceptar nuestra <a href="{{ route('privacy') }}">Política de Privacidad</a>.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-header bg-white border-0">
                                    <h3 class="h5 fw-bold mb-0"><i class="fas fa-ban text-danger me-2"></i> Prohibiciones
                                    </h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                    ...
                                    <div class="alert alert-danger mt-3 mb-0">
                                        <i class="fas fa-exclamation-circle me-2"></i> El incumplimiento puede resultar en
                                        la <strong>terminación inmediata</strong> de tu acceso al Servicio sin reembolso.
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="reservas" class="mb-5">
                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-body">
                                    ...
                                    <p>FlyLow actúa como <strong>mero intermediario</strong> entre tú y los Socios
                                        Proveedores. El contrato de transporte se celebra directamente con la aerolínea.</p>

                                    <div class="alert alert-info">
                                        <i class="fas fa-info-circle me-2"></i> <strong>Importante:</strong> No vendemos
                                        billetes de avión ni somos una agencia de viajes. Somos un comparador independiente.
                                    </div>
                                    ...
                                    <p class="mt-3"><i class="fas fa-external-link-alt me-2"></i> Consulta siempre las
                                        <strong>Condiciones de Transporte</strong> específicas de tu aerolínea.</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="precios" class="mb-5">
                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-body">
                                    ...
                                    <p>Los precios mostrados son <strong>estimaciones</strong> basadas en información
                                        recibida de aerolíneas y partners. FlyLow:</p>
                                    <ul>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <div class="p-3 border rounded bg-light h-100">
                                                <h5 class="fw-bold"><i class="fas fa-calendar-alt text-primary me-2"></i>
                                                    Temporalidad</h5>
                                                <p class="mb-0">Precios varían por temporada alta/baja, días de la semana y
                                                    hora del día.</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="p-3 border rounded bg-light h-100">
                                                ...
                                                <p class="mb-0">Los precios aumentan cuando quedan pocos asientos
                                                    disponibles.</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="p-3 border rounded bg-light h-100">
                                                <h5 class="fw-bold"><i class="fas fa-cog text-warning me-2"></i>
                                                    Configuración</h5>
                                                <p class="mb-0">Opciones como equipaje, asientos y seguros afectan el precio
                                                    final.</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <section id="propiedad" class="mb-5">
                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-body">
                                    ...
                                    <p>Todos los elementos del Servicio son propiedad de FlyLow o se utilizan con licencia:
                                    </p>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <ul>
                                    ...
                                    <p>Concedemos una licencia <strong>no exclusiva, intransferible y revocable</strong>
                                        para:</p>
                                    <ol>
                                    ...
                                    <div class="alert alert-warning mt-3">
                                        <i class="fas fa-exclamation-triangle me-2"></i> <strong>Prohibido:</strong>
                                        Cualquier uso comercial no autorizado, incluyendo scraping, minería de datos o
                                        reproducción masiva de contenido.
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="limitacion" class="mb-5">
                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-body">
                                    ...
                                    <p>En caso de responsabilidad demostrada, nuestra obligación se limitará al
                                        <strong>menor</strong> de:</p>
                                    <ol>
                        ...
                        <section id="ley-aplicable" class="mb-5">
                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-body">
                                    <h4 class="fw-bold mb-3" id="legislacion-aplicable">8.1 Legislación Aplicable</h4>
                                    ...
                                    <h4 class="fw-bold mt-4 mb-3" id="resolucion-conflictos">8.2 Resolución de Conflictos
                                    </h4>
                                    <p>En caso de disputa:</p>
                                    <ol>
                                        <li>Contacta con nuestro <a href="mailto:info@flylow.com">servicio al cliente</a>
                                        </li>
                                        <li>Plataforma de Resolución de Litigios en Línea de la UE (<a
                                                href="https://ec.europa.eu/consumers/odr" target="_blank"
                                                rel="noopener">ODR</a>)</li>
                                        <li>Tribunales de <a href="https://maps.google.com/?q=Madrid, España"
                                                target="_blank" rel="noopener">Madrid (España)</a></li>
                                    </ol>

                                    <h4 class="fw-bold mt-4 mb-3" id="contacto-legal">8.3 Contacto</h4>
                                    <p>Para cuestiones legales:</p>
                                    <address>
                                        <strong>MOTJR</strong><br>
                                        <a href="https://maps.google.com/?q=Gandia, Valencia" target="_blank"
                                            rel="noopener">Gandia, Valencia</a><br>
                                        <i class="fas fa-envelope me-2"></i> <a
                                            href="mailto:info@flylow.com">info@flylow.com</a><br>
                                        <i class="fas fa-phone me-2"></i> <a href="tel:+34900123456">+34 900 123 456</a>
                                    </address>
                                </div>
                            </div>
                        </section>
