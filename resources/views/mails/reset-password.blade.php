...
<head>
    ...
    <title>Restablecer contraseña - FlyLow</title>
    <style>
        /* Estilos base */
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Hemos recibido una solicitud para restablecer la contraseña de tu cuenta en FlyLow.</p>

            <div class="user-info">
                <div class="info-item">
                    <span class="info-label">Solicitado por:</span> {{ $user->email }}
                </div>
                <div class="info-item">
                    <span class="info-label">Fecha de solicitud:</span> {{ now()->format('d/m/Y H:i') }}
                </div>
            </div>

            <p class="urgent-note">Por razones de seguridad, este enlace expirará en 60 minutos.</p>

            <div style="text-align: center;">
                <a href="{{ $resetUrl }}" class="cta-button">Restablecer Contraseña</a>
            </div>

            <p>Si no reconoces esta actividad o no solicitaste un cambio de contraseña, por favor ignora este mensaje o
                contacta con nuestro equipo de soporte inmediatamente.</p>
            <p>Para tu seguridad, nunca compartas este enlace con nadie.</p>
        </div>
